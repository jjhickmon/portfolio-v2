...
function Raivn() {
    return (
        <div className='subpage'>
            ...
            <ul>
                <li>
                    Led the development of a novel method to utilize generative
                    diffusion-based model ensembling to improve multimodal{" "}
                    <b>fine-grained image classification</b> accuracy.
                    <ul>
                        <li>
                            We have already achieved accuracies higher than
                            OpenAI's CLIP ViT-L/14 model on a variety of
                            datasets, although the project is currently still in
                            development.
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    within <b>Large Language Models</b> to improve image
                    classification for <b>Multimodal Machine Learning</b>{" "}
                    models.
                </li>
                <li>
                    Wrote custom evaluation code, resulting in a{" "}
                    <b>~15x evaluation speedup</b> while decreasing the
                    misclassification rate of our system.
                </li>
                <li>
                    Independently wrote the implementation of{" "}
                    <b>multimodal chain-of-thought</b> and showed consistently
                    higher accuracies on a subset of images from the ImageNet
                    dataset.
                </li>
            </ul>
            <p>
            ...
            <p>
                Artificial intelligence has made significant progress in image
                classification, an essential task for machine perception to
                achieve human-level image understanding. Despite recent advances
                in vision-language fields, multimodal image classification is
                still challenging, particularly for the following two reasons.
                First, models with low capacity often suffer from underfitting
                and thus underperform on fine-grained image classification.
                Second, it is important to ensure high-quality data with rich
                cross-modal representations of each class, which is often
                difficult to generate. Here, we utilize Ensemble Learning to
                reduce the impact of these issues on pre-trained models. We aim
                to create a meta-model that combines the predictions of multiple
                open-vocabulary multimodal models trained on different data to
                create more robust and accurate predictions. By utilizing
                ensemble learning for multimodal models, we will achieve higher
                prediction accuracies without any additional training or
                fine-tuning, meaning that this method is completely zero-shot.
                <br />
                <br />
            ...
            <p>
                ...
                <br />
                <br />I presented this work at the{" "}
                <a
                    target='_blank'
                    rel='noopener noreferrer'
                    href='https://starscelebration.org/'>
                    2023 STARS Celebration
                </a>{" "}
                and the{" "}
                <a
                    target='_blank'
