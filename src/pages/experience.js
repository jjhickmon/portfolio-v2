...
function Experience() {
    ...
    useEffect(function () {
        document.querySelectorAll('.resume-card').forEach(function (resume_card) {
            ...
            resume_card.addEventListener('mouseover', function () {
                if (card.current === null) {
                    document.getElementById('subpage-background').style.transition = "all 0.3s ease, z-index 1ms ease-out";
                    document.getElementById('subpage-background').style.opacity = "1";
                    document.getElementById('subpage-background').style.zIndex = "1";
                    resume_card.style.transition = "all 0.3s ease, z-index 1ms ease-out";
                    resume_card.style.zIndex = '2';
                }
            });
            resume_card.addEventListener('mouseout', function () {
                if (card.current === null) {
                    document.getElementById('subpage-background').style.transition = "all 0.3s ease, z-index .5s ease-in";
                    document.getElementById('subpage-background').style.opacity = "0";
                    document.getElementById('subpage-background').style.zIndex = "-1";
                    resume_card.style.transition = "all 0.3s ease, z-index .3s ease-in";
                    resume_card.style.zIndex = '0';
                }
            });
        });
                        ...
                        <div className="resume-card" id="peleg">
                            ...
                            <div className="resume-card-right">
                                <div className="job-description">
                                    <ul>
                                        <li>
                                            Proposed the implementation of state-of-the-art Computer Vision methods 
                                            to improve the temporal coherence of the honeybee object segmentation.
                                        </li>
                                        <li>
                        ...
                        <div className="resume-card" id="raivn">
                            ...
                            <div className="resume-card-right">
                                <div className="job-description">
                                    <ul>
                                        <li>
                                            Worked to utilize chain-of-thought prompting as a means of leveraging
                        ...
                        <div className="resume-card" id="uw">
                            ...
                            <div className="resume-card-right">
                                <div className="job-description">
                                    <ul>
                                        <li>
                                            Assted workshops for CSE 121, 122, 123, 142 & 143 at the University of Washington.
                                        </li>
                                        <br />
                                        <li>
